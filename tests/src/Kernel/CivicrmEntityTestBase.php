...
abstract class CivicrmEntityTestBase extends KernelTestBase implements ServiceModifierInterface {
  ...
  protected function mockCiviCrmApi(ContainerBuilder $container) {
    ...
    $civicrm_api_mock->get('contact', [
      ...
      'options' => ['limit' => 0],
    ])->willReturn($this->sampleContactData([1]));
    ...
    $civicrm_api_mock->get('contact', [
      ...
      'return' => array_keys($this->sampleContactGetFields()),
      'options' => ['limit' => 0],
    ])->willReturn($this->sampleContactData([1, 2, 3, 4, 5, 6]));
  ...
  protected function sampleContactData() {
    return [
      0 => [
        ...
        'phone' => '',
        'email_id' => '1',
        'email' => 'fixme.domainemail@example.org',
        'on_hold' => '0',
        'im_id' => '',
        'provider_id' => '',
        'im' => '',
      ...
      5 => [
        ...
        'contact_type' => 'Organization',
        'contact_sub_type' => '',
        'sort_name' => 'The Trevor Project',
        'display_name' => 'The Trevor Project',
        'do_not_email' => '0',
        'do_not_phone' => '0',
        'do_not_mail' => '0',
        'do_not_sms' => '0',
