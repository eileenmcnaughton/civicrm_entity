 ...
 *        description = @Translation("Set account to active. Leave empty to not activate the account."),
 ...
 *        description = @Translation("Send account notification email. Leave empty to not send an account notification email."),
 *        assignment_restriction = "input",
 *        default_value = TRUE,
 *        required = FALSE
 *      ),
 ...
 *        description = @Translation("Automatically log in as the created user. Leave empty to not automatically log in the user."),
 *        assignment_restriction = "input",
 *        default_value = TRUE,
 *        required = FALSE
 *      ),
