 ...
 * - first field: The field in the 'civicrm_group_contact' table to match against the
 *   original table.
 * - second field: The field in the 'civicrm_group_contact' table to match against
 *   the base table.
 *
 ...
 */
class CiviCrmGroupContact extends RelationshipPluginBase {
  ...
  public function query() {
    ...
    // Add a join to the civicrm_group_contact table with the matching contact_id.
    $first = [
    ...
    $first_alias = $this->query->addTable('civicrm_group_contact', $this->relationship, $first_join);
    ...
    $alias = $this->definition['base'] . '_civicrm_group_contact';
